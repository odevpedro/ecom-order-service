...
public class ShippingClient {
    ...
    @CircuitBreaker(name = "shipping", fallbackMethod = "fallbackCalculateShipping")
    ...
    private Map<String, Object> fallbackCalculateShipping(String fromCep, String toCep, double weightKg, Exception e) {
